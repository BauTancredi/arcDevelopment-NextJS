    ...
    <Grid container direction="column">
      <Head>
        ...
        <meta
          name="description"
          key="description"
          content="Mobile Apps Made Easy | Our cutting-edge mobile apps development process let us build beautifully, carefully crafted apps for both iOS and Android. "
        />
        <meta
          property="og:title"
          key="og:title"
      ...
      >
        <Hidden mdDown>
          ...
          >
            ...
            >
              <img src="/assets/backArrow.svg" alt="Back to Custom Softare" />
            </IconButton>
          </Grid>
        </Hidden>
